...
from "SPARC_BASE"."ECOM_ANALYTICS"."FACT_DEMAND" as MAO
...
LEFT JOIN Date_Table as Date_Table on Date_Table.CALDT=MAO.DEMAND_DATE
WHERE MAO.DEMAND_DATE >= '2023-05-08'
)
GROUP BY
BRAND_LOCATION,
LOCATION_PK,
