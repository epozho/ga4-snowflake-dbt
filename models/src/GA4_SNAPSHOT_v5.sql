...
EP.EP_MEDIUM as LastTouch_EventParameter_Medium,
EP.EP_CAMPAIGN as LastTouch_EventParameter_Campaign,
EP.EP_SOURCE as LastTouch_EventParameter_Source,
...
LEFT JOIN "SPARC_BASE"."ECOM_ANALYTICS"."LAST_TOUCH_EP" as EP ON EP.USER_SESSION_KEY=GA4.USER_SESSION_KEY
LEFT JOIN 
(
Select distinct 
Product.Article,
...
ORDER BY GA4.USER_SESSION_KEY, GA4.EVENT_TIMESTAMP DESC
)