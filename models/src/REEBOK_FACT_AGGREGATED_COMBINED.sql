...
CONCAT(DATEDIFF(day, '1900-01-01'::TIMESTAMP, TRANSACTION_DATE)+1,'|',BRAND_LOCATION_ID) as BUSINESS_PERFORMANCE_DATE_LOCATION_KEY,
...
--Common
'GA4' as SOURCE,
CONCAT(DATEDIFF(day, '1900-01-01'::TIMESTAMP, EVENT_DATE)+1,'|','R0700') as BUSINESS_PERFORMANCE_DATE_LOCATION_KEY,
CONCAT(ACCTGPRDMNTHNUM,'|',KEY_CATEGORY_DESC) as PRODUCT_DETAIL_STYLE_MONTH_KEY,
...
--Common
SOURCE as SOURCE,
CONCAT(DATEDIFF(day, '1900-01-01'::TIMESTAMP, DEMAND_DATE)+1,'|','R0700') AS BUSINESS_PERFORMANCE_DATE_LOCATION_KEY,
CONCAT(ACCTGPRDMNTHNUM,'|',KEY_CATEGORY_DESC) AS PRODUCT_DETAIL_STYLE_MONTH_KEY,
DEMAND_DATE AS TRANSACTION_DATE,
DIVISION_NAME,
--STYLE as STYLE_NAME,
BUSINESS_SEGMENT_DESC,
KEY_CATEGORY_DESC,
