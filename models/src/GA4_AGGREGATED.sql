...
--The below script is divided into 2 groups, one is to ensure that all of the USER_SESSION_KEY's for purchase items are addressed correctly for their last touch traffic and the second query 
