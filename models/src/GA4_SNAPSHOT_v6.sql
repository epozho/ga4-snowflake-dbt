...
--(CASE WHEN LENGTH(Month.ACCTGPRDMNTHNUM)=1 THEN CONCAT('0',Month.ACCTGPRDMNTHNUM) ELSE Month.ACCTGPRDMNTHNUM END) as ACCTGPRDMNTHNUM,
CONCAT(EXTRACT(YEAR FROM Month.ACCTGPRDMNTHENDDT),(CASE WHEN LENGTH(Month.ACCTGPRDMNTHNUM)=1 THEN CONCAT('0',Month.ACCTGPRDMNTHNUM) ELSE Month.ACCTGPRDMNTHNUM END)) as ACCTGPRDMNTHNUM
from 
(
Select 
