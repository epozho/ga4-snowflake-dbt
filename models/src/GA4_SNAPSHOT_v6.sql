...
CONCAT(EXTRACT(YEAR FROM Month.ACCTGPRDMNTHENDDT),(CASE WHEN LENGTH(Month.ACCTGPRDMNTHNUM)=1 THEN CONCAT('0',TO_VARCHAR(Month.ACCTGPRDMNTHNUM)) ELSE TO_VARCHAR(Month.ACCTGPRDMNTHNUM) END)) as ACCTGPRDMNTHNUM 
(
Select 
